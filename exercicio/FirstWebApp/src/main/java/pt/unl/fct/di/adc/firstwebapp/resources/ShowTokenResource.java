...
public class ShowTokenResource {
	...
	public Response showToken(ShowTokenData data) {
		...
		return Response.ok("{ username:" + token.getString("username") + ", role:" + token.getString("role")
				+ ", tokenId:" + token.getString("tokenId") + ", validFrom:" + token.getLong("validFrom") + ", validTo:"
				+ token.getLong("validTo") + " }").build();
